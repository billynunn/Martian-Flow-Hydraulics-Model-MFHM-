...
# Key Features
As the result of the projects time-constraints, MFHM implements a limited but integral set of hydraulic functions required to reconstruct Martain rivers. The current implementation encompasses several key measurements, including: velocity, discharge, stream power, and Froude number.
